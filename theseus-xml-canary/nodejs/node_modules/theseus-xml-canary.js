...
const theseusXmlCanary = async function () {
    ...
    let requestOptionsStep1 = {
        ...
        body: "",
        headers: {
            'Authorization': 'Basic ZHJtOmVzMjAxOTgw'
        }
    };
   ...
   let stepConfig1 = {
    ...
    await synthetics.executeHttpStep('Verify theseus.bbctest01.uk/xml.php', requestOptionsStep1, validateSuccessful, stepConfig1);
